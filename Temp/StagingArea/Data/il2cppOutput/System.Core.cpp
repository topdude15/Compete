...
IL_002d:
		{
			...
			bool L_10 = Double_IsNaN_m5DFBBD58036879B687FEC248C50EACBABE205AB3((((double)((double)(double)L_9))), /*hidden argument*/NULL);
			if (!L_10)
			{
				goto IL_003e;
			}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR float Enumerable_Average_m48238E2FDB29EE702DAD6BBAD1D019D8D4550FFF (RuntimeObject* ___source0, const RuntimeMethod* method)
{
	...
	StackTraceSentry _stackTraceSentry(Enumerable_Average_m48238E2FDB29EE702DAD6BBAD1D019D8D4550FFF_RuntimeMethod_var);
	double V_0 = 0.0;
	int64_t V_1 = 0;
	RuntimeObject* V_2 = NULL;
	float V_3 = 0.0f;
...
IL_0024:
		{
			...
			double L_6 = V_0;
			float L_7 = V_3;
			V_0 = ((double)il2cpp_codegen_add((double)L_6, (double)(((double)((double)(double)L_7)))));
			int64_t L_8 = V_1;
...
IL_0049:
	...
	}
	{
		double L_14 = V_0;
		int64_t L_15 = V_1;
		return (((float)((float)(float)((double)((double)L_14/(double)(((double)((double)L_15))))))));
	}
